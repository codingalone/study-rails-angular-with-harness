...
> **注**: 本一覧は全 Phase 完了時の目標構成。CI_CD.md は Phase 2 で本一覧と整合するよう更新する。Angular SAST、committee、strong_migrations、Actions SHA ピン留めは CI_CD.md にまだ反映されていないため、Phase 2 で追加する。
